...
class PriceRange(models.Model):
    # 对外键进行过滤
    # limit_choices_to的作用是设置筛选条件,官方文档连接：
    # https://docs.djangoproject.com/en/1.10/ref/models/fields/#django.db.models.ForeignKey.limit_choices_to
    category = models.ForeignKey(GoodsCategory, limit_choices_to={'parent_category': None}, verbose_name="商品类目")
    min = models.IntegerField(default=0, verbose_name='最低值')
    max = models.IntegerField(default=0, verbose_name='最高值')
